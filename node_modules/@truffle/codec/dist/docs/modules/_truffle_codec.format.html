		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					<pre><code class="language-typescript"><span class="hljs-comment">// when importing entire Codec, use Codec.Format.*:</span>
<span class="hljs-keyword">import</span> * <span class="hljs-keyword">as</span> Codec <span class="hljs-keyword">from</span> <span class="hljs-string">"@truffle/codec"</span>;

<span class="hljs-comment">// or import Format directly:</span>
<span class="hljs-keyword">import</span> { Format } <span class="hljs-keyword">from</span> <span class="hljs-string">"@truffle/codec"</span>;</code></pre>
				...
				<section class="tsd-panel tsd-index-panel">
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							<h3>Main Format Modules</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-module tsd-parent-kind-module"><a href="_truffle_codec.format.errors.html" class="tsd-kind-icon">Errors</a></li>
								<li class="tsd-kind-module tsd-parent-kind-module"><a href="_truffle_codec.format.types.html" class="tsd-kind-icon">Types</a></li>
								<li class="tsd-kind-module tsd-parent-kind-module"><a href="_truffle_codec.format.values.html" class="tsd-kind-icon">Values</a></li>
							</ul>
							<h3>Other Modules</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-module tsd-parent-kind-module"><a href="_truffle_codec.format.utils.html" class="tsd-kind-icon">Utils</a></li>
							</ul>
						</section>
					</div>
				</section>
